...
export const courses: Course[] = [
  ...
  },
  {
    ...
    stages: [
      ...
      { id: '6.3', title: 'AARRR指标体系', emoji: '📈', description: '增长指标 / 各环节指标设计',          topicCount: 4, mdFile: '../../data_tk_learning/6.3 AARRR指标体系.md' },
      { id: '6.4', title: 'KPI体系设计',   emoji: '📐', description: 'KPI原则 / 指标层级 / 常见陷阱',        topicCount: 4, mdFile: '../../data_tk_learning/6.4 KPI体系设计原则.md' },
      // 第七章：实验思维
      { id: '7.1', title: 'A/B测试思维',   emoji: '🧪', description: '统计基础 / 实验流程 / 常见陷阱',      topicCount: 4, mdFile: '../../data_tk_learning/7.1 A-B测试思维.md' },
      // 第八章：可视化思维
      { id: '8.1', title: '数据可视化',   emoji: '📊', description: '图表选择 / 设计原则 / 叙事结构',       topicCount: 4, mdFile: '../../data_tk_learning/8.1 数据可视化思维.md' },
      // 第九章：场景组合
      { id: '9.1', title: '场景与模型组合', emoji: '🔗', description: '增长 / 流失 / 活动 / 产品分析',       topicCount: 4, mdFile: '../../data_tk_learning/9.1 常见分析场景与思维模型组合.md' },
      // 第十章：方法论框架
      { id: '10.1', title: '方法论框架',   emoji: '📋', description: 'DMAIC / CRISP-DM / 通用流程',        topicCount: 4, mdFile: '../../data_tk_learning/10.1 数据分析方法论框架.md' },
      // 第十一章：高级分析
      { id: '11.1', title: '因果推断',     emoji: '🔬', description: '因果识别 / 准实验 / 效应估计',      topicCount: 4, mdFile: '../../data_tk_learning/11.1 因果推断.md' },
      { id: '11.2', title: '网络分析',     emoji: '🕸️', description: '社交网络 / 节点关系 / 传播路径',      topicCount: 4, mdFile: '../../data_tk_learning/11.2 网络分析.md' },
      { id: '11.3', title: '文本分析',     emoji: '📝', description: 'NLP / 情感分析 / 主题建模',          topicCount: 4, mdFile: '../../data_tk_learning/11.3 文本分析.md' },
      // 第十二章：避坑指南
      { id: '12.1', title: '避坑指南',     emoji: '⚠️', description: '认知偏差 / 数据陷阱 / 数据质量',        topicCount: 4, mdFile: '../../data_tk_learning/12.1 避坑指南.md' },
    ],
  },
]
