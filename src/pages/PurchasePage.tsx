    ...
    <div className="purchase">
      ...
      <section className="purchase__value-cards">
        <div className="purchase__value-card">
          ...
          <h3 className="purchase__value-title">9 个付费模块</h3>
          <p className="purchase__value-desc">SQL 高级 5 阶段 + Python 进阶 4 阶段</p>
        </div>
        <div className="purchase__value-card">
          <span className="purchase__value-icon">💻</span>
        ...
        <div className="purchase__value-card">
          <span className="purchase__value-icon">🔄</span>
          <h3 className="purchase__value-title">持续更新</h3>
          <p className="purchase__value-desc">新增内容免费获取</p>
        </div>
      </section>

      <section className="purchase__pricing">
        <div className="purchase__pricing-card">
          <div className="purchase__pricing-badge">限时早鸟价</div>
          <div className="purchase__price-row">
            <span className="purchase__price">{PRICING.currency}{PRICING.currentPrice}</span>
            <span className="purchase__price-original">{PRICING.currency}{PRICING.originalPrice}</span>
          </div>
          <ul className="purchase__includes">
            <li className="purchase__includes-item">✓ SQL 子查询与CTE</li>
            <li className="purchase__includes-item">✓ SQL 窗口函数</li>
            <li className="purchase__includes-item">✓ SQL 数据操作与建表</li>
            <li className="purchase__includes-item">✓ SQL 高级分析技巧</li>
            <li className="purchase__includes-item">✓ SQL 实战项目</li>
            <li className="purchase__includes-item">✓ Python 数据分析核心库</li>
            <li className="purchase__includes-item">✓ Python 数据分析实战</li>
            <li className="purchase__includes-item">✓ Python 统计与机器学习</li>
            <li className="purchase__includes-item">✓ Python 进阶主题</li>
          </ul>
